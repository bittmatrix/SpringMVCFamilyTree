                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="p in ctrl.persons">
                              <td><span ng-bind="p.key"></span></td>
                              <td><span ng-bind="p.name"></span></td>
                              <td><span ng-bind="p.m"></span></td>
                              <td><span ng-bind="p.f"></span></td>
                              <td><span ng-bind="p.g"></span></td>
                              <td><span ng-bind="p.dob"></span></td>
                              
                              <td>
                              	<a ng-href="/FamilyTreeMVC/ancestors/{{p.key}}" class="btn btn-primary">Ancestors</a>  
                              	<a ng-href="/FamilyTreeMVC/descendants/{{p.key}}" class="btn btn-primary">Descendants</a>
                              </td>
                          </tr>
                      </tbody>
                  </table>
